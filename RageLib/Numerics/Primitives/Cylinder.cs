...
{
    public readonly struct Cylinder : IEquatable<Cylinder>, IPrimitive
    {
        public readonly Vector3 Vertex1;
        public readonly Vector3 Vertex2;
        public readonly float Radius;

        public Cylinder(Vector3 center1, Vector3 center2, float radius)
        {
            Vertex1 = center1;
            Vertex2 = center2;
            Radius = radius;
        ...
        public bool Equals(Cylinder other) => this == other;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override bool Equals(object obj) => (obj is Cylinder other) && Equals(other);
